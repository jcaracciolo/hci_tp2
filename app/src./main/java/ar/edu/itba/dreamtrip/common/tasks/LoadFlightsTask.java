...
public class LoadFlightsTask extends AsyncTaskInformed<Object,Void,ArrayList<String>>{

    private Context context;
    private HashSet<FlightDependency> flightDependencies;

    public LoadFlightsTask(Context context, HashSet<FlightDependency> flights) {
        flightDependencies = flights;
        this.context = context;
    }

    public LoadFlightsTask(Context context, String originID, String destID, String depDate) {
    ...
    public HashSet<Dependency> getDependencies() {
        ...
        dependencies.addAll(flightDependencies);
        return dependencies;
    }
