...
public class FlightStateCheckService extends JobService {
    @Override
...
//        startService(i);
        DataHolder.getInstance(getApplicationContext()).waitForIt(new FlightStateCheckTask(getApplicationContext()));
